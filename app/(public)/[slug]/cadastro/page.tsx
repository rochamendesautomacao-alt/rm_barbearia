...
export default async function CadastroClientePage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="max-w-lg mx-auto px-4 py-8">
        ...
        <FormCadastroCliente slug={slug} />

        <p className="text-center text-zinc-500 text-sm mt-6">
          Já tem conta?{' '}
          <Link href={`/${slug}/entrar`} className="text-amber-400 hover:text-amber-300">
            Entrar
          </Link>
        </p>
