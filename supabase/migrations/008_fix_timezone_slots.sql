-- =============================================================
-- Migration 008: Corrige timezone na função horarios_disponiveis
-- Os horários cadastrados (hora_inicio/hora_fim) são em horário
-- local (America/Sao_Paulo). A função precisa gerar slots como
-- TIMESTAMPTZ corretos, interpretando as horas como BRT.
-- =============================================================
