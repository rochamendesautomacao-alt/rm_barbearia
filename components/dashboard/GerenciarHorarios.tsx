  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-4">
        <h2 className="text-white font-bold text-sm tracking-tight">Adicionar / Editar dia</h2>
            ...
            {[...horarios]
              ...
              .map(h => (
                <div
                  key={h.id}
                  className={[
                    'bg-zinc-900/80 border rounded-2xl px-4 py-3 flex items-center justify-between gap-3 transition-all duration-200',
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center text-zinc-400 hover:text-amber-400
                                 rounded-xl hover:bg-zinc-800 transition-all duration-200"
                    >
